CREATE TABLE matricula(
	...
	CONSTRAINT pk_turma_aluno PRIMARY KEY (codTurma, CodAluno),
	CONSTRAINT FK_turma FOREIGN KEY (codTurma) REFERENCES turma(codTurma),
	CONSTRAINT FK_alunos FOREIGN KEY (CodAluno) REFERENCES aluno(CodAluno),
	CONSTRAINT FK_disciplina FOREIGN KEY (codDisc) REFERENCES disciplina(codDisc)
);
